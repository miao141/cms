...
<!-- 弹出框 crawlwebDlg -->
  ...
  <tr>
    <td><label> 网站域名: </label></td>
	  <td >
		<input name="domain" class="easyui-validatebox"  />
	  </td>
  ...
  <tr>
    <td><label> 状态: </label></td>
	  ...
	  <td >
		<input name="create_time" class="easyui-validatebox" />
     </td>
  </tr>
  <tr>
    <td><label> 关闭: </label></td>
	  <td >
		<input name="source" class="easyui-validatebox"  />
	  </td>
	  <td><label> 创建时间: </label></td>
	  <td >
		<input name="server" class="easyui-validatebox" />
     </td>
  </tr>
  <tr>
    <td><label> 完整域名: </label></td>
	  <td >
		<input name="onwer" class="easyui-validatebox"  />
	  </td>
  </tr>
  </table>
  </form>

...
<script type="text/javascript">
	//导入
	$("#tbcContentImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbcContent/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbcContentImportDlg">
	<a href="javascript:void(0)" id="tbcContentImport">导入</a>
</div>
...
<script type="text/javascript">
	//导入
	$("#tbcTempImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbcTemp/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbcTempImportDlg">
	<a href="javascript:void(0)" id="tbcTempImport">导入</a>
</div>
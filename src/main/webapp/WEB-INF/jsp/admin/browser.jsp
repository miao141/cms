...
<script type="text/javascript">
    ...
    var browserChartType="line";
    browserChartDateType(4);//时
	function browserChartDateType(type){
		var url='${demoPath}admin/browserData.html?type='+type;
		$.getJSON(url, function(result) {
			browserChartData=result;
			browserChart(browserChartType,result);
		});
	}
    
	function browserChart(type,result){
		var data;
		if(result=='' || result==null){
			result=browserChartData;
		}
		if(type=='' || type==null){
			type=browserChartType;
		}
...
<div style="margin:0 1em;padding-top: 2px;">
	<div id="browserChart" style="min-width: 400px; height: 400px; margin: 0 auto"></div>
</div>

...
<script type="text/javascript">
	...
	function tbcListTempGridAddAndEdit(title, url, type) {
		...
		$('<div/>').dialog({
			href : '${demoPath}admin/TbcListTemp/baseDlg.html',
			modal : true,
			title : title,
			top : '15%',
			left : '30%',
	...
	function tbcListTempGridDel() {
		...
		if (rows.length > 0) {
			...
			var url = '${demoPath}admin/TbcListTemp/del.html?' + ids;
	...
	function tbcListTempGridReload() {
		$('#tbcListTempGrid').datagrid('options').pageNumber=1;
		$('#tbcListTempGrid').datagrid('reload',{});
	}
	...
	function tbcListTempSearch() {
		$('<div/>').dialog({
			href : '${demoPath}admin/TbcListTemp/searchDlg.html',
			modal : true,
			title : '高级查询',
			top : 120,
			width : 480,
	...
	//导出
	function tbcListTempGridExport(){
		window.location="${demoPath}admin/TbcListTemp/export.html";
	...
	//导入
	function tbcListTempGridImport(){
		$('<div/>').dialog({
			href : '${demoPath}admin/TbcListTemp/importDlg.html',
			modal : true,
			title : '导入',
			top : '15%',
			left : '30%',
    ...
    <div data-options="region:'center',border : false">
		...
		<table id="tbcListTempGrid"  class="easyui-datagrid"  data-options="	
			url:'${demoPath}admin/TbcListTemp/data.html',
			...
			{field:'href',title:'href',hidden:false,width:'135',halign:'center',align:'center',sortable:'true', formatter: function(value,row,index){
			    return value;
			}},			
		...
		<div id="tbcListTempGridToolbar">
			<div style="margin-bottom:5px">
				...
				<%-- 
				<a href="javascript:void(0)" onclick="javascript:tbcListTempGridAddAndEdit('添加  tbcListTemp','${demoPath}admin/TbcListTemp/add.html',0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">添加</a>
				<a href="javascript:void(0)" onclick="javascript:tbcListTempGridAddAndEdit('修改  tbcListTemp','${demoPath}admin/TbcListTemp/save.html',1)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'">编辑 </a>  
				<a href="javascript:void(0)" onclick="javascript:tbcListTempGridDel()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'">删除</a>
				<a href="javascript:void(0)" onclick="javascript:tbcListTempGridReload()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'">刷新</a>
				<a href="javascript:void(0)" onclick="javascript:tbcListTempGridExport()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'">导出</a>
				<a href="javascript:void(0)" onclick="javascript:tbcListTempGridImport()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-reload'">导入</a>
				...
				<a href="javascript:void(0)" onclick="javascript:tbcListTempSearch()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'">高级查询</a>
			</div>
		</div>
	</div>
<!--  <div>-->
...
<script type="text/javascript">
	//导入
	$("#tbcListTempImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbcListTemp/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbcListTempImportDlg">
	<a href="javascript:void(0)" id="tbcListTempImport">导入</a>
</div>
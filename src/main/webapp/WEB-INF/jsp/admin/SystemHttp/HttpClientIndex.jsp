...
<script type="text/javascript">
   ...
   function httpClientIndexTest1(type){
	  ...
	  alert(params);
      var url='${demoPath}admin/TbsHttpRequest/http.html?'+params;
      httpTestDialog(url); 
   }
			...
			<table>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(1)">抓取测试</a>
                  </td>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(2)">规则测试 </a>
                  </td>
                </tr>
                <tr>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(3)">入库测试 </a>
                  </td>
                </tr>
			</table>
		</form>

...
<script type="text/javascript">
	//导入
	$("#tbcConTempImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbcConTemp/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbcConTempImportDlg">
	<a href="javascript:void(0)" id="tbcConTempImport">导入</a>
</div>
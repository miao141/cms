...
<table>
  ...
  <tr>
    <td><label> 动作: </label></td>
	  <td >
		<input name="action" class="easyui-validatebox" type="text" />
	  </td>
  ...
  <tr>
    <td><label> 虚节点列表: </label></td>
	  <td >
		<input name="next" class="easyui-validatebox" type="text" />
	  </td>
	  <td><label> 虚节点: </label></td>
	  <td >
		<input name="dataprocess" class="easyui-validatebox"  type="text" />
     </td>
  </tr>
		</table>
</form>

			...
			<tr>
				...
				<td>
					<select name="searchColumnNames">
						...
						<option value="listSplitUrlChar">横中线分割符</option>
				...
				<td>
					...
					<td><input name="searchVals" size="18"> <a href="javascript:void(0)">日期框</a> <a href="javascript:void(0)" onclick="tbsHttpRequestSearchRemove(this)">删除</a>
				</td>
			</tr>
		</table>
	</form>

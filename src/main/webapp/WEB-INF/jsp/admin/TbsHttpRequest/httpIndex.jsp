...
<script type="text/javascript">
   ...
   function httpClientIndexTest1(type,title){
      ...
      var url = '${demoPath}admin/TbsHttpRequest/http.html?type='+type+'&t='+Math.random();
      //alert(queryString);
      $.post(url, queryString,function(data){
           $('<div/>').dialog({
			            height : $(window).height()-150,
			            width : $(window).width()-300,
			            href : '${demoPath}admin/TbsHttpRequest/httpDialog.html?t='+Math.random(),
			           // content : data,
						cache: false,
						resizable:true,
						modal : true,
...
<div id="tabs" class="easyui-tabs" data-options="fit : true,border : false">
			...
			<table>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(1,'抓取测试')">抓取测试</a>
                  </td>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(2,'规则测试')">规则测试 </a>
                  </td>
                </tr>
                <tr>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(3,'查看SQL')">查看SQL </a>
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(4,'入库')">入库 </a>
                  </td>
                </tr>
			</table>
		</form>
	      ...
	      <table>
	            <tr>
				  ...
				  <td colspan="2">
				     ...
				     <a style="margin-left: 10px;" href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(5,'抓取测试')">抓取测试</a>
				  </td>
				</tr>
				<tr>
                  <td>请求第:</td>
                ...
                <tr>
                  <td></td>
                  <td colspan="2">
                        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(6,'查看地址测试')">查看地址测试</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(7,'抓取页面测试')">抓取页面测试</a>
                  </td>
                </tr>
               <tr>
					<td><label> jquery 表达式 : </label></td>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(8,'规则测试')">规则测试 </a>
                  </td>
                </tr>
                <tr>
					<td><label> 入库 表达式 : </label></td>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(9,'查看SQL')">查看SQL </a>
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(18,'入库')">入库 </a>
                  </td>
                </tr>
		  </table>
		</form>
	      ...
	      <table>
	           <tr>
				  ...
				  <td colspan="2">
				     ...
				     <label>必须为URL地址,导航页url属性表达式</label>
				     <a style="margin-left: 10px;" href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(10,'抓取测试')">抓取测试</a>
				  </td>
				</tr>
				<tr>
                  <td>请求第:</td>
                  <td colspan="2">
                       ...
                       <a style="margin-left: 10px;" href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(11,'抓取测试')">抓取测试</a>
                  </td>
                </tr>
                <tr>
					<td><label> jquery 表达式 : </label></td>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(12,'规则测试')">规则测试 </a>
                  </td>
                </tr>
                <tr>
					<td><label> 入库 表达式 : </label></td>
				...
				<tr>
                  <td colspan="2" align="center">
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(13,'查看SQL')">查看SQL </a>
                     <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(14,'入库')">入库 </a>
                  </td>
                </tr>
		  </table>
		</form>
	...
	<div title="抓取" style="padding:10px;">
	   <form id="httpClientForm3" method="post">
	      <table>
	          <tr>
				 <a href="javascript:void(0)" class="easyui-linkbutton" onclick="httpClientIndexTest1(15,'开始抓取')">开始抓取</a>
			  </tr>
	      </table>
	   </form>
	</div>

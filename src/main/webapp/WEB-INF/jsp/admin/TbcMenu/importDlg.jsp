...
<script type="text/javascript">
	//导入
	$("#tbcMenuImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbcMenu/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbcMenuImportDlg">
	<a href="javascript:void(0)" id="tbcMenuImport">导入</a>
</div>
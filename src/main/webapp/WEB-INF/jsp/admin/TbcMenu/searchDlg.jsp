...
<!-- 高级查询  tbcMenuSearchDlg-->
<div id="tbcMenuSearchDlg">
	<form id="tbcMenuSearchFm" method="post">
		<table>
			<tr>
				<th>条件</th>
				<th>字段名</th>
			...
			<tr>
				...
				<td>
					...
					<td><input name="searchVals" size="18"> <a href="javascript:void(0)">日期框</a> <a href="javascript:void(0)" onclick="tbcMenuSearchRemove(this)">删除</a>
				</td>
			</tr>
		</table>
	</form>

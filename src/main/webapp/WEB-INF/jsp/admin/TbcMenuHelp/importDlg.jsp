...
<script type="text/javascript">
	//导入
	$("#tbcMenuHelpImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbcMenuHelp/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbcMenuHelpImportDlg">
	<a href="javascript:void(0)" id="tbcMenuHelpImport">导入</a>
</div>